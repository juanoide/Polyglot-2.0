...
<form:form action="description/language/admin/edit.do?languageId=${languageId}" requestURI="${requestURI}" modelAttribute="description">
	<fieldset>
		<legend align="left">
	...
	onclick="javascript: window.location.replace('description/language/admin.do?languageId=${languageId}&&languageDescriptionId=${description.language.id}')"/>
</form:form>