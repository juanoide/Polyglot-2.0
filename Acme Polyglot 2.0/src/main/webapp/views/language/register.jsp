...
<form:form requestURI="${requestURI}" modelAttribute="languageForm">
	<fieldset>
		<legend align="left">
	...
	<acme:select code="language.descriptionLanguage" path="descriptionLanguage" items="${languages}" itemLabel="code" id="languages" />
