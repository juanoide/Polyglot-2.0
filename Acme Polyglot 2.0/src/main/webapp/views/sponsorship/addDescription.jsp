...
<form:form action="sponsorship/agent/addDescription.do?sponsorshipId=${sponsorshipId}" modelAttribute="description">
	<fieldset>
		<legend align="left">
	...
	<acme:select code="sponsorship.descriptionLanguage" path="Language" items="${languages}" itemLabel="code" id="languages" />
